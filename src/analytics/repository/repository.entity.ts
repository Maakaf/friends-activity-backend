...
export class RepositoryEntity {
  ...
  @Column('text', { nullable: true, name: 'owner_user_id' }) ownerUserId!:
    | string
    | null;
  @Column('text', { nullable: true, name: 'repo_name' }) repoName!:
    | string
    | null;
  ...
  @Column('text', { nullable: true, name: 'default_branch' }) defaultBranch!:
    | string
    | null;
  @Column('int', { nullable: true, name: 'fork_count' }) forkCount!:
    | number
    | null;
  @Column('timestamptz', { nullable: true, name: 'last_activity' })
  lastActivity!: Date | null;
  @Column('timestamptz', { nullable: true, name: 'created_at' })
